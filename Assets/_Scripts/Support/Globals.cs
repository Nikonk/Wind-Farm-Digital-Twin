...
public static class Globals
{
    ...
    private static ReadOnlyDictionary<InGameResource, GameResource> _readonlyDictionary =
        new ReadOnlyDictionary<InGameResource, GameResource>
        (
    ...
    private static float _energyTransferArea = 10;
    ...
    public static float EnergyTransferArea => _energyTransferArea;
